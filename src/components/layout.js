          ...
          <meta name="theme-color" content={data.sanityCompanyInfo.secondarycolor.hex} />
              <style>{`
                  ...
                  <script>{`(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
                    ...
                    <script data-api-key="s125da2s6hshj7oh6w639ppc" data-schedulerid="sched_qpfsy4voj5ugkkqw4dq2rv1o" defer="" id="se-widget-embed" src="https://embed.scheduler.servicetitan.com/scheduler-v1.js" data-react-helmet="true"></script>
      </Helmet>
      <noscript>
